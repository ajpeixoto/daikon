...
public @interface AuditEvent {
    ...
    /**
     * @return Category of the event. For example: activity, security, etc. The value will be converted to lower case.
     */
    String category();

    /**
     * @return Text message for the event. It can include placeholders to be replaced with values from MDC context.
    ...
    /**
     * @return Level to log this message with. Possible values: INFO, WARNING, ERROR.
     */
    // CHECKSTYLE:ON
