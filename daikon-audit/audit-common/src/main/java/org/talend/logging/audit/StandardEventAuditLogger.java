 ...
 *
 * <p>
 * If some events that application needs are missing here, it can create a custom java interface which extends this one
 * and define events similarly (see {@link EventAuditLogger} for details).
 *
 * <p>
 * Any method can accept an instance of {@link Throwable} and/or an instance of {@link Context} as parameters.
 *
